...
- `excludeOriginPackagePatterns` - List of package patterns to exclude from the rule. If the caller is in a package that matches any of these patterns, the rule will not be enforced..
  - Default: `Empty`.
